...
function testBaseComponentData (classComponent: any) {
  it('should fail if name is not provided', () => {
    const name = ''
    expect(() => new classComponent(name, 'valid', 'valid'))
  ...
  it('should fail if cluster is not provided', () => {
    const cluster = ''
    expect(() => new classComponent('valid', cluster, 'valid'))
  ...
  it('should fail if namespace is not provided', () => {
    const namespace = ''
    expect(() => new classComponent('valid', 'valid', namespace))
...
describe ('RelayComponent', () => {
  it('should fail if name is not provided', () => {
    const name = ''
    expect(() => new RelayComponent(name, 'valid', 'valid', []))
      .to.throw(SoloError, `Invalid name: ${name}`)
  })
  ...
  it('should fail if cluster is not provided', () => {
    const cluster = ''
    expect(() => new RelayComponent('valid', cluster, 'valid', []))
      .to.throw(SoloError, `Invalid cluster: ${cluster}`)
  })
  ...
  it('should fail if namespace is not provided', () => {
    const namespace = ''
    expect(() => new RelayComponent('valid', 'valid', namespace, []))
      .to.throw(SoloError, `Invalid namespace: ${namespace}`)
  })
  ...
  it('should fail if consensusNodeAliases is not valid', () => {
    ...
    expect(() => new RelayComponent('valid', 'valid', 'valid', consensusNodeAliases))
      .to.throw(SoloError, `Invalid consensus node alias: 1, aliases ${consensusNodeAliases}`)
  })
...
describe ('ConsensusNodeComponent', () => {
  it('should fail if name is not provided', () => {
    const name = ''
    expect(() => new ConsensusNodeComponent(name, 'valid', 'valid', ConsensusNodeStates.STARTED))
      .to.throw(SoloError, `Invalid name: ${name}`)
  })
  ...
  it('should fail if cluster is not provided', () => {
    const cluster = ''
    expect(() => new ConsensusNodeComponent('valid', cluster, 'valid', ConsensusNodeStates.STARTED))
      .to.throw(SoloError, `Invalid cluster: ${cluster}`)
  })
  ...
  it('should fail if namespace is not provided', () => {
    const namespace = ''
    expect(() => new ConsensusNodeComponent('valid', 'valid', namespace, ConsensusNodeStates.STARTED))
      .to.throw(SoloError, `Invalid namespace: ${namespace}`)
  })
