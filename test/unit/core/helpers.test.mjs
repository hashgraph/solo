...
describe('Helpers', () => {
  ...
  it.each([
    { input: 'v0.42.5', output: 'hashgraph/solo-charts/ubi8-init-java17' },
    { input: 'v0.45.1', output: 'hashgraph/solo-charts/ubi8-init-java17' },
    { input: 'v0.46.0', output: 'hashgraph/solo-charts/ubi8-init-java21' },
    { input: 'v0.47.1', output: 'hashgraph/solo-charts/ubi8-init-java21' },
    { input: 'v0.47.1-alpha.0', output: 'hashgraph/solo-charts/ubi8-init-java21' },
    { input: HEDERA_PLATFORM_VERSION, output: 'hashgraph/solo-charts/ubi8-init-java21' }
