...
import {type ClusterReference, type ICluster} from '../../../../../src/core/config/remote/types.js';

describe('Cluster', () => {
  it('should convert to an object', () => {
    const clusterData: ICluster = {
      name: 'name',
      namespace: 'namespace',
    ...
    const clusterObject: ICluster = cluster.toObject();
