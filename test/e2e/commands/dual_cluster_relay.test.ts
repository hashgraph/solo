...
argv[flags.clusterRef.name] = 'cluster-2';
argv[flags.deploymentClusters.name] = 'cluster-1,cluster-2';
argv[flags.context.name] = 'kind-cluster-1,kind-cluster-2';
argv[flags.namespace.name] = namespace.name;
argv[flags.releaseTag.name] = HEDERA_PLATFORM_VERSION_TAG;
argv[flags.nodeAliasesUnparsed.name] = 'cluster-1=node1,cluster-2=node2';
