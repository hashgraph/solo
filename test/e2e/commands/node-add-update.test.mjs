...
import { getDefaultArgv, getTmpDir, HEDERA_PLATFORM_VERSION_TAG } from '../../test_util.js'
...
describe('Node add with released hedera', () => {
  ...
  const bootstrapResp = testNodeAdd(localBuildPath, false)
  const nodeCmd = bootstrapResp.cmd.nodeCmd
  const k8 = bootstrapResp.opts.k8
  const namespace = bootstrapResp.namespace
  const newAccountId = '0.0.7'
  const updateNodeId = 'node4'
