...
public record RepositoryRemoveRequest(Repository repository) implements HelmRequest {
    public RepositoryRemoveRequest {
        Objects.requireNonNull(repository, "repository must not be null");
    }

    @Override
    public void apply(HelmExecutionBuilder builder) {
        builder.subcommands("repo", "remove").positional(repository.name());
    }
}
