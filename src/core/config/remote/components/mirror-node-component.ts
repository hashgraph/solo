...
export class MirrorNodeComponent extends BaseComponent {
  public constructor(
    ...
    super(ComponentTypes.MirrorNode, name, cluster, namespace, phase);
    this.validate();
  }
  ...
  public static fromObject(component: BaseComponentStruct): MirrorNodeComponent {
    return new MirrorNodeComponent(component.name, component.cluster, component.namespace, component.phase);
  }
}
