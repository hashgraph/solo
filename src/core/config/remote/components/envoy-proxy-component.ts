...
export class EnvoyProxyComponent extends BaseComponent {
  public constructor(
    ...
    super(ComponentTypes.EnvoyProxy, name, cluster, namespace, phase);
    this.validate();
  }
  ...
  public static fromObject(component: BaseComponentStruct): EnvoyProxyComponent {
    return new EnvoyProxyComponent(component.name, component.cluster, component.namespace, component.phase);
  }
}
